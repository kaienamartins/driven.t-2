...
describe('createEnrollmentSchema', () => {
    const generateValidInput = () => ({
        ...
        address: {
            ...
            number: faker_1.faker.datatype.number().toString(),
            state: faker_1.faker.helpers.arrayElement(brazilian_utils_1.getStates()).code,
            neighborhood: faker_1.faker.address.secondaryAddress(),
            addressDetail: faker_1.faker.lorem.sentence(),
        },
    });
    it('should return an error if input is not present', () => {
        const result = schemas_1.createEnrollmentSchema.validate(null);
    ...
    describe('name', () => {
        it('should return error if name is not present', () => {
            ...
            delete input.name;
            const { error } = schemas_1.createEnrollmentSchema.validate(input);
            expect(error).toBeDefined();
        });
        it('should return error if name is less than 3 characters', () => {
            const input = generateValidInput();
            input.name = faker_1.faker.lorem.word(2);
            const { error } = schemas_1.createEnrollmentSchema.validate(input);
            expect(error).toBeDefined();
        });
    });
    ...
    describe('address', () => {
        ...
        describe('street', () => {
            ...
            it('should return error if street is not a string', () => {
                const input = generateValidInput();
                const { error } = schemas_1.createEnrollmentSchema.validate({
                    ...input,
                    address: {
                        ...input.address,
                        street: faker_1.faker.datatype.number(),
                    },
                });
                expect(error).toBeDefined();
            });
        ...
        describe('city', () => {
            ...
            it('should return error if city is not a string', () => {
                ...
                const { error } = schemas_1.createEnrollmentSchema.validate({
                    ...
                    address: {
                        ...input.address,
                        city: faker_1.faker.datatype.number(),
                    },
                });
                expect(error).toBeDefined();
            });
        ...
        describe('number', () => {
            ...
            it('should return error if number is not a string', () => {
                ...
                const { error } = schemas_1.createEnrollmentSchema.validate({
                    ...
                    address: {
                        ...input.address,
                        number: faker_1.faker.datatype.number(),
                    },
                });
                expect(error).toBeDefined();
            });
        ...
        describe('neighborhood', () => {
            ...
            it('should return error if neighborhood is not a string', () => {
                ...
                const { error } = schemas_1.createEnrollmentSchema.validate({
                    ...
                    address: {
                        ...input.address,
                        neighborhood: faker_1.faker.datatype.number(),
                    },
                });
                expect(error).toBeDefined();
            });
        ...
        describe('addressDetail', () => {
            ...
            it('should return error if addressDetail is not a string', () => {
                ...
                const { error } = schemas_1.createEnrollmentSchema.validate({
                    ...
                    address: {
                        ...input.address,
                        addressDetail: faker_1.faker.datatype.number(),
                    },
                });
                expect(error).toBeDefined();
            });
